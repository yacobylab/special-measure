function smanaContinue(xt, inst)
% smanatrig(xt, inst)
...
%fprintf(obj, ':TRIG:SOUR BUS'); %LYY commented out 2018 inst waits for external trigger
...
%LYY commented out 2018 for continuos mode
