function val = smcLabBrickHID(ic, val, ~)
% Control function for LabBricks from Vaunix. uses HID drivers, doesn't
% work as well on current Matlab/Windows
%function val = smcLabBrick(ic, val, ~)
