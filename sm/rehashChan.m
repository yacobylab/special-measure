...
% Connect channels to instruments using strings instead of numbers, so that if smdata reordered, no problems occur. 
% function rehashChan(opts)
% inst name stored in smdata.channels(i).inst. 
% to initialize and save inst names, call with 'init'
% to redo all the instchans after moving / deleting insts, call with 'rehash'
