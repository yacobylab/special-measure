...
/* Reads an unsigned 32-bit noncomplex scalar to control. */

void lia_readU32(double control[], uint32_t value[])
{
	...
	NiFpga_ReadU32(session, control[0], value);
                  ...
                  int nrhs, const mxArray *prhs[] )
{
  ...
  plhs[0] = mxCreateNumericMatrix(mrows,ncols, mxUINT32_CLASS, mxREAL);
