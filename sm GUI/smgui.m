...
function makeloopchannelset(i,j) 
    ...
    elseif j==1 %first setchan in locked trafofn mode, loop range != [0 1];
         %minimum
        loopcvars_sth(i,j,2) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','text',...
            'String','Min:',...
            'HorizontalAlignment','right');
        loopcvars_eth(i,j,2) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','edit',...
        ...
        %max
        loopcvars_sth(i,j,3) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','text',...
            'String','Max:',...
            'HorizontalAlignment','right');
        loopcvars_eth(i,j,3) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','edit',...
        ...
        %mid
        loopcvars_sth(i,j,4) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','text',...
            'String','Mid:',...
            'HorizontalAlignment','right');
        loopcvars_eth(i,j,4) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','edit',...
        ...
        %range
        loopcvars_sth(i,j,5) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','text',...
            'String','Range:',...
            'HorizontalAlignment','right');
        loopcvars_eth(i,j,5) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','edit',...
        ...
        %stepsize
        loopcvars_sth(i,j,6) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','text',...
            'String','Step:',...
            'HorizontalAlignment','right');
        loopcvars_eth(i,j,6) = uicontrol('Parent',smaux.smgui.loop_panels_ph(i),...
            'Style','edit',...
